...
class Builder {
  ...
  static queryBuilder() {
    ...
    const query = `${select} ${from} ${Connector.joinGrammar === '' ? '' : `${Connector.joinGrammar} `}${Connector.whereGrammar === '' ? '' : `${Connector.whereGrammar} `}${Connector.orderByGrammar === '' ? '' : `${Connector.orderByGrammar} `}${Connector.groupByGrammar === '' ? '' : `${Connector.groupByGrammar} `}${Connector.havingGrammar === '' ? '' : `${Connector.havingGrammar} `}${mix === '' ? '' : `${mix} `}`;
    return query;
  }
