...
class Builder {
   ...
   * @memberof Builder
   */
  whereColumn(firstColumn, secondColumn) {
    connector.bindings.where.push(`${firstColumn} = ${secondColumn}`);
   ...
   * @memberof Builder
   */
  orWhereColumn(firstColumn, secondColumn) {
    connector.bindings.orWhere.push(`${firstColumn} = ${secondColumn}`);
