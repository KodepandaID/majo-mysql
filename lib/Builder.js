const compileInsert = require('./Grammar/Compiler');
...
class Builder {
  ...
  insert(...args) {
    if (args.length === 1 && !args[0].length) {
      this.insertGrammar = compileInsert.compileInsert(this.tables, args[0]);
    } else {
      this.insertGrammar = compileInsert.compilerInsertArray(this.tables, args);
    }
