...
class Table {
  ...
  dropPrimary(column = 'id') {
    ...
    connector.queries.push(`ALTER TABLE ${toSchema} MODIFY COLUMN ${column} INT NOT NULL`);
    connector.queries.push(`ALTER TABLE ${toSchema} DROP PRIMARY KEY`);
    return this;
  }
  ...
  primary(column) {
    const toSchema = Table.getSchema();
    connector.queries.push(`ALTER TABLE ${toSchema} ADD PRIMARY KEY(${column})`);
    return this;
  }
